  ...
  return (
    <div className="w-full min-h-screen flex flex-col">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/images/birthday-hero.jpg')",
        }}
      >
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight">
            Creating Magical Moments: <br />
            Top Birthday Party Event Planner
          </h1>

          <p className="mt-4 max-w-2xl text-gray-200">
            We specialize in crafting unforgettable birthday experiences
            with complete planning, decoration, entertainment, and catering services.
          </p>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-gray-600 leading-8">
            Celebrating birthdays with your loved ones is timeless. We ensure your day
            is stress-free and full of joy.
          </p>
        </div>
      </motion.section>
      ...
      <section className="bg-gray-50 min-h-[70vh] flex items-center">
        <div className="max-w-6xl mx-auto px-6 py-16 w-full">
          ...
          >
            {["Creative Idea Generation", "Our Value", "Customization"].map((title, i) => (
              <motion.div
                key={i}
                variants={itemVariant}
              ...
              >
                ...
                <p className="text-gray-600">
                  We ensure memorable and personalized celebrations.
                </p>
              </motion.div>
            ))}
          </motion.div>
